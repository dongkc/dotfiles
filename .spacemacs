...
(defun dotspacemacs/user-init ()
 ...
 (setq configuration-layer--elpa-archives
    '(("melpa-cn"   . "http://elpa.emacs-china.org/melpa/")
      ("ort-cn"     . "http://elpa.emacs-china.org/org/")
